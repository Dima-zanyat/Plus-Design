...
from sqlalchemy import Boolean, Column, ForeignKey, Index, Integer, String, Table, Text, text, true
...
class Tag(Base):
    ...
    items: Mapped[list["PortfolioItem"]] = relationship(
        secondary=portfolio_item_tags, back_populates="tags"
    )
...
class PortfolioItem(Base, TimestampMixin):
    ...
    tags: Mapped[list[Tag]] = relationship(
        secondary=portfolio_item_tags, back_populates="items"
    )
